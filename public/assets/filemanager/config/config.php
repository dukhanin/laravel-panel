...
| <input type="button" href="../filemanager/dialog.php?field_id=imgField&lang=en&akey=myPrivateKey" value="Files">
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => parse_url(upload()->url(), PHP_URL_PATH) . '/',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../upload/thumbs/' . upload()->subdir() . '/',
